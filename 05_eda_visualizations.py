...
def plot_class_distribution(df: pd.DataFrame) -> None:
    ...
    ax.set_title(
        "Class Distribution — Fake vs True", fontsize=15, fontweight="bold", pad=12
    )
...
def plot_text_length_histogram(df: pd.DataFrame) -> None:
    ...
    ax.set_title(
        "Distribution of Article Text Length", fontsize=15, fontweight="bold", pad=12
    )
...
def plot_avg_text_length(df: pd.DataFrame) -> None:
    ...
    ax.set_title(
        "Average Article Text Length — Fake vs True",
        fontsize=15,
        fontweight="bold",
        pad=12,
    )
